  ...
  <Box className="!flex !flex-col md:!flex-row !gap-6 md:!gap-10 !relative !group sm:!items-center md:!items-start !py-6">
    ...
    <Box className="!flex !flex-col !relative sm:!items-center md:!items-start">
      <Box className="!hidden md:!block !absolute !left-0 !top-[-24px] !h-[calc(100%+48px)] !w-[2px] !-translate-x-1/2">
        <Box className="!absolute !inset-0 !bg-gradient-to-b !from-emerald-300/30 !via-emerald-500/40 !to-emerald-300/30" />
      </Box>

      <Box
        className="!hidden md:!block !absolute !left-0 !top-[13px] !-translate-x-1/2 !w-3 !h-3 !rounded-full !bg-primary !z-10 !transition-all !duration-300 
      ...
      <Box className="md:!pl-8 !flex !flex-col sm:!items-center md:!items-start">
        <Typography className="!text-primary !font-semibold !text-lg md:!text-xl !mb-2 sm:!text-center md:!text-left">
          {title}
        </Typography>
