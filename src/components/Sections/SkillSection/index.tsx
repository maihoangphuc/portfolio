...
const SkillSection = () => {
  ...
  return (
    <SectionContainer
      ...
      classChildren="!flex !items-center !justify-center"
    >
      <Box className="!flex !flex-col md:!flex-row !gap-1 md:!gap-8 !items-center !justify-center !h-full !w-full md:!w-[100%] lg:!w-[80%] !mx-auto">
        <Box className="!w-full md:!w-[40%] !h-full">
          <MacbookFrame
